            ...
            <div class="row">
              ...
              <div class="col-md-10">
                <div class="card-body p-0">
                  ...
                  <p class="card-text">Disfruta de envíos sin costo adicional en todas tus compras a nivel nacional.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-10">
                <div class="card-body p-0">
                  ...
                  <p class="card-text">Realiza tus pagos con total confianza en nuestra web.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-10">
                <div class="card-body p-0">
                  ...
                  <p class="card-text">Todos nuestros productos tienen una garantía.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-10">
                <div class="card-body p-0">
                  ...
                  <p class="card-text">Nuestro equipo está disponible 24/7 para resolver cualquier duda.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-10">
                <div class="card-body p-0">
                  ...
                  <p class="card-text">Descubre nuevas promociones y descuentos exclusivos todos los días.</p>
                </div>
              </div>
            </div>
          </div>
